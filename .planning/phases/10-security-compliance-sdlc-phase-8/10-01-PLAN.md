...
- File contains `angel.generateOwaspChecklist`
- File contains `angel.checkCompliance`
- `tsc --noEmit` passes
</acceptance_criteria>
...
3. **Add contributions** to `package.json` under `"contributes"."commands"`:
   ```json
   {
     "command": "angel.generateOwaspChecklist",
     "title": "Angel: Generate OWASP Checklist for PRD",
     "category": "Angel"
   },
   {
     "command": "angel.checkCompliance",
     "title": "Angel: Check GDPR/HIPAA Compliance",
     "category": "Angel"
   }
   ```
</action>
...
- `package.json` contains `"angel.generateOwaspChecklist"`
- `package.json` contains `"angel.checkCompliance"`
- `tsc --noEmit` passes with zero errors
- `angel.generateOwaspChecklist` and `angel.checkCompliance` appear in Command Palette (F1)
</acceptance_criteria>
